def DefaultParam(method='Online_EWMA'):
    ...
    #   - EWMA (matlab version only so far): a simple exponentially weighted moving =
    #   average without recovery algorithm
    ...
    # Limit for the whole data feature calculation For now,
    # every limit (Min and Max) are equal to None because it's the operator
